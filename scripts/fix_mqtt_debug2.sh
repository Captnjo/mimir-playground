...
ls -la ~/working_mqtt.py 2>/dev/null || echo "Script not found at ~/working_mqtt.py"
ls -la /root/working_mqtt.py 2>/dev/null || echo "Script not found at /root/working_mqtt.py"
...
# Create the Python script using a different method
cat > /home/jo/test_mqtt_simple.py <> 'PYEOF'
#!/usr/bin/env python3
import ssl
...
chmod +x /home/jo/test_mqtt_simple.py
echo ""
echo "=== Run with: python3 /home/jo/test_mqtt_simple.py ==="
